...
public class ShardKeyDataloader extends KeyedProcessFunction<Long,String,TracingPoint> {
    ...
    public ShardKeyDataloader(String host, String port) throws IOException {
        this.host = host;
        this.port = port;
        trajectoryShardKey = new HashMap<>();
        slotTrajectory = new HashMap<>();
