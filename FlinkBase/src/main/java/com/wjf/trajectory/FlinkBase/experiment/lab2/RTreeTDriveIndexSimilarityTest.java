...
public class RTreeTDriveIndexSimilarityTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new RTreeTDriveIndexSimilarityTest().apply(env);
    }
    ...
    public void apply(StreamExecutionEnvironment env) throws Exception {
        ...
        SingleOutputStreamOperator<QueryPair> queryPairSingleOutputStreamOperator = pointStream
                ...
                .process(new RTreeQueryPairGenerator(timeWindowSize,continuousQueryNum,step,distMeasure,xz2SFC))
                .name("广播数据结合点信息相似度计算");
        //写入文件
